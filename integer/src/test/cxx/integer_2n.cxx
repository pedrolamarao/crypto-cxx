...
TYPED_TEST(integer_2n_test,sum_equisized_1_0_0)
{
    auto x = TypeParam::create(1);
    auto y = TypeParam::create(1);
    ...
    auto [sum,carry] = sum_equisized(x,y);

    ASSERT_EQ( sum[0],  0 );
    ASSERT_EQ( carry, 0 );
}

TYPED_TEST(integer_2n_test,sum_equisized_1_0_1)
{
    auto x = TypeParam::create(1);
    auto y = TypeParam::create(1);
...
TYPED_TEST(integer_2n_test,sum_equisized_1_0_max)
{
    using unit = typename TypeParam::unit;
    unit max = unit(-1); // guaranteed by C++
...
TYPED_TEST(integer_2n_test,sum_equisized_1_1_0)
{
    auto x = TypeParam::create(1);
    auto y = TypeParam::create(1);
...
TYPED_TEST(integer_2n_test,sum_equisized_1_1_1)
{
    auto x = TypeParam::create(1);
    auto y = TypeParam::create(1);
...
TYPED_TEST(integer_2n_test,sum_equisized_1_1_max)
{
    using unit = typename TypeParam::unit;
    unit max = unit(-1); // guaranteed by C++
...
TYPED_TEST(integer_2n_test,sum_equisized_1_max_0)
{
    using unit = typename TypeParam::unit;
    unit max = unit(-1); // guaranteed by C++
...
TYPED_TEST(integer_2n_test,sum_equisized_1_max_1)
{
    using unit = typename TypeParam::unit;
    unit max = unit(-1); // guaranteed by C++
...
TYPED_TEST(integer_2n_test,sum_equisized_1_max_max)
{
    using unit = typename TypeParam::unit;
    unit max = unit(-1); // guaranteed by C++
...
TYPED_TEST(integer_2n_test,sum_equisized_2_0_0)
{
    auto x = TypeParam::create(2);
    auto y = TypeParam::create(2);
...
TYPED_TEST(integer_2n_test,sum_equisized_2_0_1)
{
    auto x = TypeParam::create(2);
    auto y = TypeParam::create(2);
...
TYPED_TEST(integer_2n_test,sum_equisized_2_0_max)
{
    using unit = typename TypeParam::unit;
    unit max = unit(-1); // guaranteed by C++
...
TYPED_TEST(integer_2n_test,sum_equisized_2_1_0)
{
    auto x = TypeParam::create(2);
    auto y = TypeParam::create(2);
...
TYPED_TEST(integer_2n_test,sum_equisized_2_1_1)
{
    auto x = TypeParam::create(2);
    auto y = TypeParam::create(2);
...
TYPED_TEST(integer_2n_test,sum_equisized_2_1_max)
{
    using unit = typename TypeParam::unit;
    unit max = unit(-1); // guaranteed by C++
...
TYPED_TEST(integer_2n_test,sum_equisized_2_max_0)
{
    using unit = typename TypeParam::unit;
    unit max = unit(-1); // guaranteed by C++
...
TYPED_TEST(integer_2n_test,sum_equisized_2_max_1)
{
    using unit = typename TypeParam::unit;
    unit max = unit(-1); // guaranteed by C++
...
TYPED_TEST(integer_2n_test,sum_equisized_2_max_max)
{
    using unit = typename TypeParam::unit;
    unit max = unit(-1); // guaranteed by C++
